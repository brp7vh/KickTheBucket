...
public class BucketListAdapter extends RecyclerView.Adapter<BucketListAdapter.ViewHolder> {
    ...
    private List<BucketItem> mTodo;
    // Store the context for easy access
    private Context mContext;

    // Pass in the contact array into the constructor
    public BucketListAdapter(Context context, List<BucketItem> item) {
        mTodo = item;
        mContext = context;
    }
    ...
    public void onBindViewHolder(BucketListAdapter.ViewHolder viewHolder, int position) {
        ...
        BucketItem todo = mTodo.get(position);

        // Set item views based on your views and data model
        TextView textView = viewHolder.nameTextView;
        textView.setText(BucketItem.getTodo());
